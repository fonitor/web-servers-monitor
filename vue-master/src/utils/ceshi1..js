...
var SEQUENCE = Date.now(),
    ...
    util = {
        ...
        createObject: function (t) {
            ...
            return t && "string" == typeof t ? t.replace(/^\.\./, "pages").replace(/^\//, "") : ""
        }, getRandIP: function () {
            for (var t = [], e = 0; e < 4; e++) {
    ...
    Base = function (t) {
        return this.ver = "1.0.7", this.syn = 0, this._conf = util.ext({}, Base.dftCon), this.sampleCache = {}, this.requestQueue = [], this.hash = util.seq(), this.resetSession(), this.setConfig(t), this.rip = util.getRandIP(), this._common = {}, this
    };
Base.dftCon = {
    sample: 1,
    tag: "",
...
var base = Base,
    validApiKeys = ["api", "success", "time", "code", "msg", "begin", "response"],
...
MiniProgramLogger.prototype = util.createObject(Reporter.prototype), util.ext(Reporter._root.dftCon, {
    ...
    onReady: function (e) {
        ...
        var e = this;
        clearTimeout(e.sendPVTimmer), e.sendHealthOnPageShowOrHide(), e.sendPVTimmer = setTimeout(function () {
            e._conf.autoReportPage && e.sendPV()
        }, 100), e.sessionPage = e.getPage()
    }, pageHide: function () {
            ...
            t = {
                onShow: function () {
                    ...
                    try {
                        ...
                        util.warn("[cloudMonitor] error in hookPage:pageShow", r)
                    }
                    ...
                    try {
                        ...
                        util.warn("[cloudMonitor] error in hookPage:onHide", r)
                    }
                    if ("function" == typeof n) {
                        return n.apply(this, t)
                    }
                    ...
                    try {
                        ...
                        util.warn("[cloudMonitor] error in hookPage:onUnload", r)
                    }
                    if ("function" == typeof n) {
                        return n.apply(this, t)
                    }
        ...
        var e = this, spmId = util.toHex(e._conf.getCurrentPage()), spmPre = util.toHex(e._conf.getPrePage());
        !e.entrance && (e.entrance = spmId, spmPre = "E");

        e.onReady(function () {
            e._lg("pv", { spmPre: spmPre || "", spmId: spmId || "", scene: e._conf.scene || "" })
        })
    },
    _lgPV: function (t) {
        if (!t) return;
        ...
        !t.spmPre && (t.spmPre = util.toHex(this.getPage()) || ""), !t.spmId && (t.spmId = util.toHex(t.page) || ""), !t.scene && (t.scene = this._conf.scene || ""), this._lg("pv", t);
    },
...
AlipayLogger.prototype = util.createObject(MiniProgramLogger.prototype), util.ext(MiniProgramLogger._root.dftCon, {
    ...
    autoSetCommonInfo: function () {
        this.setCommonInfo({
            app: "mini_alipay"
        }), this.autoSetNetworkType(), this.autoSetUid(), this.autoSystemInfo()
    }, autoSetUid: function () {
        var t = this;
                            ...
                            var p = {
                                success: function (t) {
                                    ...
                                    if (t.data && (!i.dataType || i.dataType === "json")) {
                                        var d = t.data;
                                        c = util.getPropertyValue(d, e._conf.code) || d.stat || d.status || d.code || d.success;
                                        u = util.getPropertyValue(d, e._conf.msg) || d.msg || d.message || d.subMsg || d.errorMsg || d.ret || d.errorResponse || "";
                                        "object" == typeof u && (c = c || u.code, u = u.msg || u.message || u.info || u.ret || JSON.stringify(u));
                                        util.pick(10000) && (r = (r = JSON.stringify(d)).substr(0, 256));
                                    }
                                    e.api({
                                        api: o,
                                        success: !0,
                                    ...
                                    n == "" && t.error && (n = t.error);
                                    var u = "";
                                    t && t.body && (u = (u = JSON.stringify(t.body)).substring(0, 256)), e.api({
                                        api: o,
                                        success: !1,
                                        time: s - a,
                                        code: n,
    ...
    init: function (t) {
        ...
        if (!t.ignore) {
            t.ignore = {
                ignoreUrls: [/\.(png|jpg|gif|jpeg)$/, /[\"{}]+/]
            }
        }
        this.setConfig(t), this.addHook();
        if (p && e._conf.autoReportPage) {
            e.entrance = util.toHex(p);
            e.onReady(function () {
                e._lg("pv", { spmPre: "E", spmId: e.entrance || "", scene: e._conf.scene || "" })
            })
        }
        return this;
    }
